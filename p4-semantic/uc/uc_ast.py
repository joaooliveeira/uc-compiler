...
class BinaryOp(Node):
    __slots__ = ("op", "left", "right", "coord", "uc_type", "props")
...
class Constant(Node):
    __slots__ = ("type", "value", "uc_type", "props")
...
class Program(Node):
    __slots__ = ("gdecls", "coord", "uc_type", "scope")
...
class ArrayDecl(Node):
    __slots__ = ("type", "dim", "coord", "uc_type", "props")
...
class ArrayRef(Node):
    __slots__ = ("name", "subscript", "coord", "uc_type", "props")
...
class Cast(Node):
    __slots__ = ("type", "expr", "coord", "uc_type", "props")
...
class Decl(Node):
    __slots__ = ("name", "type", "init", "coord", "uc_type", "scope")
...
class For(Node):
    __slots__ = ("init", "cond", "next", "body", "coord", "uc_type", "props")
...
class FuncCall(Node):
    __slots__ = ("name", "args", "coord", "uc_type", "props")
...
class FuncDecl(Node):
    __slots__ = ("args", "type", "coord", "props")
...
class FuncDef(Node):
    __slots__ = ("spec", "decl", "param_decls", "body", "coord", "props")
...
class ID(Node):
    __slots__ = ("name", "coord", "uc_type", "props", "scope")
...
class If(Node):
    __slots__ = ("cond", "ifthen", "ifelse", "coord", "uc_type", "props")
...
class VarDecl(Node):
    __slots__ = ("declname", "type", "coord", "props")
...
class UnaryOp(Node):
    __slots__ = ("op", "expr", "coord", "uc_type", "props")
...
class While(Node):
    __slots__ = ("cond", "body", "coord", "uc_type", "props")
