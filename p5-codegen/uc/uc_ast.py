    ...
    def _repr(obj, indent, printed_set):
        ...
        if isinstance(obj, list):
            ...
            for name in obj.__slots__[:-1]:
                ...
                uc_type.append(name + "=" + value_str)
            sep = ",\n" + (" " * indent)
            final_sep = ",\n" + (" " * (indent - 1))
            result += sep.join(uc_type)
            result += ")"
            return result
    ...
    def show(
        ...
        if self.attr_names:
            if attrnames:
                ...
                uc_typetr = ", ".join("%s=%s" % nv for nv in nvlist)
            else:
...
class BinaryOp(Node):
    __slots__ = ("op", "left", "right", "coord", "uc_type", "props", "gen_location")
    ...
    def children(self):
        ...
        if self.left is not None:
            nodelist.append(("lvalue", self.left))
        if self.right is not None:
            nodelist.append(("rvalue", self.right))
...
class Constant(Node):
    __slots__ = ("type", "value", "uc_type", "props", "gen_location")

    def __init__(self, uc_type, value, coord=None):
        self.type = uc_type
        self.uc_type = None
        self.value = value
        self.coord = coord
...
class Program(Node):
    __slots__ = ("gdecls", "coord", "uc_type", "scope", "text")
...
class ArrayDecl(Node):
    __slots__ = ("type", "dim", "coord", "uc_type", "props", "init")
...
class ArrayRef(Node):
    __slots__ = ("name", "subscript", "coord", "uc_type", "props", "gen_location")

    def __init__(self, name, subscript, coord=None, scope=None):
        self.name = name
...
class Assert(Node):
    __slots__ = ("expr", "coord", "uc_type", "props", "cfg")
...
class Assignment(Node):
    __slots__ = ("op", "lvalue", "rvalue", "coord", "uc_type", "props")
...
class Cast(Node):
    __slots__ = ("type", "expr", "coord", "uc_type", "props", "gen_location")
...
class Compound(Node):
    __slots__ = ("decls", "stmts", "coord", "uc_type", "props")
...
class Decl(Node):
    __slots__ = ("name", "type", "init", "coord", "uc_type", "scope", "gen_location")
...
class DeclList(Node):
    __slots__ = ("decls", "coord", "uc_type", "scope")
...
class ExprList(Node):
    __slots__ = ("exprs", "coord", "uc_type", "scope")
...
class For(Node):
    __slots__ = ("init", "cond", "next", "body", "coord", "uc_type", "props", "cfg")
...
class FuncCall(Node):
    __slots__ = ("name", "args", "coord", "uc_type", "props", "gen_location")
...
class FuncDecl(Node):
    __slots__ = ("args", "type", "coord", "props", "return_target")
...
class FuncDef(Node):
    __slots__ = ("spec", "decl", "param_decls", "body", "coord", "props", "cfg")
...
class ID(Node):
    __slots__ = ("name", "coord", "uc_type", "props", "scope", "gen_location", "type")

    def __init__(self, name, coord=None, uc_type=None):
        self.name = name
        self.coord = coord
        self.uc_type = None
        self.scope = None
...
class If(Node):
    __slots__ = ("cond", "ifthen", "ifelse", "coord", "uc_type", "props", "cfg")
...
class InitList(Node):
    __slots__ = ("exprs", "coord", "uc_type", "props")
...
class ParamList(Node):
    __slots__ = ("params", "coord", "uc_type", "scope")
...
class Print(Node):
    __slots__ = ("expr", "coord", "uc_type", "props")
...
class Return(Node):
    __slots__ = ("expr", "coord", "uc_type", "props", "gen_location")
...
class Type(Node):
    __slots__ = ("names", "coord", "uc_type", "props")
...
class VarDecl(Node):
    __slots__ = ("declname", "type", "coord", "props", "init", "gen_location")
...
class UnaryOp(Node):
    __slots__ = ("op", "expr", "coord", "uc_type", "props", "gen_location")
...
class While(Node):
    __slots__ = ("cond", "body", "coord", "uc_type", "props", "cfg")
